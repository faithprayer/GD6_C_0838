package com.example.gd6_c_0838
...
import com.example.gd6_c_0838.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val notifactionId2 = 102
    ...
    private fun sendNotification2() {
        ...
        with(NotificationManagerCompat.from(this)) {
            notify(notifactionId2, builder.build())
        }
    }
}